-- Migration script for creating mobile-specific Razorpay tables
-- Run this script to create the required tables for Razorpay integration
-- These tables are prefixed with 'mobile_' to avoid conflicts with existing OpenCart tables
